        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shippings_Users_FromId",
                        column: x => x.FromId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Shippings_Users_ToId",
                        column: x => x.ToId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserBans_Users_ModeratorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductReviws", x => x.Id);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ProductReviws_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductReviws_ProductId",
                table: "ProductReviws",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductReviws_UserId",
                table: "ProductReviws",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shippings_FromId",
                table: "Shippings",
                column: "FromId");

            migrationBuilder.CreateIndex(
                name: "IX_Shippings_ToId",
                table: "Shippings",
                column: "ToId");

            migrationBuilder.CreateIndex(
                name: "IX_UserBans_ModeratorId",
                table: "UserBans",
                column: "ModeratorId");
